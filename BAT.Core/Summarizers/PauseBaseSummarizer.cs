...
namespace BAT.Core.Summarizers
{
	public class PauseBaseSummarizer : ISummarizer
	{
        ...
        public string[] GetHeader() { return PauseOutput.SummaryHeader; }

		/// <summary>
		/// Gets the header csv.
		/// </summary>
		/// <returns>The header csv.</returns>
		public string GetHeaderCsv() { return PauseOutput.SummaryHeaderCsv; }

		/// <summary>
		/// Gets the footer labels.
		/// </summary>
		/// <returns>The footer labels.</returns>
        public string[] GetFooterLabels() { return PauseOutput.SummaryFooter; }
        ...
        public string GetFooterCsv() { return PauseOutput.SummaryFooterCsv; }
